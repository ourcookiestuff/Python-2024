...
class SlotMachineApp:
    def __init__(self, root):
        ...
        self.symbole = [tk.PhotoImage(file="img/arbuz.png"),
                        tk.PhotoImage(file="img/cytryna.png"),
                        tk.PhotoImage(file="img/koniczyna.png"),
                        tk.PhotoImage(file="img/sliwka.png"),
                        tk.PhotoImage(file="img/truskawka.png")]
